            ...
            <div className="content flex flex-col gap-[20px]">
                <div className="factcontainer mt-[50px] ml-[50px] flex flex-col gap-[20px] align-start justify-start">
                    ...
                    <div className="facttitle">
                        <input type='text' value={contentData!.title}  className='text-[2rem] font-bold'/>
                    </div>
                    <div className='facthighlight'>
                        <input type='text' value={contentData!.highlight} className='text-[1.5rem] font-bold'/>
                    </div>
                    <div className="facttext">
                        <textarea name="" id="" cols={70} rows={10} value={contentData!.description} className='text-[1.1rem] font-normal'></textarea>
                    </div>
                </div>
